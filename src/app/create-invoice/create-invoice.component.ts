...
export class CreateInvoiceComponent implements OnInit {
  ...
  FeedToDatabase(DataArray: any) {
    ...
    this.http.get(this.urls.BaseUrl+'insertAction.php?Name='+DataArray.ProductName+'&Quantity='+DataArray.ProductQuantity+'&Price='+DataArray.ProductPrice+'&Type='+DataArray.PaymentType, DataArray)
    .subscribe({
